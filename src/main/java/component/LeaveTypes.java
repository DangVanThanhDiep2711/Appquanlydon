...
public class LeaveTypes extends JPanel {
	...
	public LeaveTypes() {
		...
		scrollPane.setBounds(10, 11, 991, 427);
		add(scrollPane);
		...
		txtLeaveTypeID.setBounds(103, 449, 59, 43);
		...
		txtLeaveTypeName.setBounds(289, 449, 354, 43);
		...
		txtLeaveTypeDescription.setBounds(167, 503, 671, 43);
		...
		txtLeaveDaysPerYear.setBounds(779, 449, 59, 43);
		...
		btnNewButton.setBounds(848, 449, 153, 28);
		...
		btnNewButton_1.setBounds(848, 488, 153, 28);
